...
/*******************************************[.]CacheProperty[.]**********************************************/
/************************************************************************************************************/
/*********************Структура предназначеная для хранения состояния свойсв обьекта.************************/
...
/***[4]. Current - Текущее значение. Это итоговый результат игровой логики, который мы применяем к обьекту.**/
/************************************************************************************************************/
